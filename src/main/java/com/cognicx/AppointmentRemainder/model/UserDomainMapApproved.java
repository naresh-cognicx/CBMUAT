...
@Entity
@Table(name = "user_domain_map_approved", schema = "user_rule")
@NamedQuery(name = "UserDomainMapApproved.findAll", query = "SELECT ui FROM UserDomainMapApproved ui")
public class UserDomainMapApproved implements Serializable {
