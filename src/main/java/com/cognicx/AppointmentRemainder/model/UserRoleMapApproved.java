...
@Entity
@Table(name = "user_roles_map_approved", schema = "user_rule")
@NamedQuery(name = "UserRoleMapApproved.findAll", query = "SELECT ui FROM UserRoleMapApproved ui")
public class UserRoleMapApproved implements Serializable {
