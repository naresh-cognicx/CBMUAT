...
public class CampaignQueryConstant {
	...
	public static final String INSERT_CAMPAIGN_DET = "INSERT INTO appointment_remainder.campaign_det(campaign_id,name,description,status,max_adv_time,retry_delay,retry_count,concurrent_call,start_date,start_time,end_date,end_time,ftp_location,ftp_credentials,file_name,dncId,groupname,DailingMode,Queue,dispositionID,previewOption)"
			+ "VALUES (:campaignId,:name,:desc,:status,:maxAdvTime,:retryDelay,:retryCount,:concurrentCall,:startDate,:startTime,:endDate,:endTime,:ftpLocation,:ftpCredentials,:fileName,:dncId,:groupname,:DailingMode,:Queue,:dispositionID,:previewOption)";
	...
	public static final String GET_CAMPAIGN_DET = "SELECT campaign_id,name,description,status,max_adv_time,retry_delay,retry_count,concurrent_call,start_date,start_time,campaign_det.end_date,end_time,ftp_location,ftp_credentials,file_name,dncId,groupname,DailingMode,Queue,dispositionID,previewOption FROM appointment_remainder.campaign_det  order by rec_add_dt desc";
	public static final String GET_CAMPAIGN_DET_BY_USERGROUP = "SELECT campaign_id,name,description,status,max_adv_time,retry_delay,retry_count,concurrent_call,start_date,start_time,campaign_det.end_date,end_time,ftp_location,ftp_credentials,file_name,dncId,groupname,DailingMode,Queue,dispositionID,previewOption FROM appointment_remainder.campaign_det where groupname=:groupName ";
	...
	public static final String UPDATE_CAMPAIGN_DET = "UPDATE appointment_remainder.campaign_det SET name = :name,status = :status,max_adv_time = :maxAdvTime,retry_delay = :retryDelay,retry_count = :retryCount,concurrent_call = :concurrentCall,start_date = :startDate,start_time = :startTime,end_date = :endDate,end_time = :endTime,ftp_location = :ftpLocation,ftp_credentials = :ftpCredentials,rec_updt_dt = getdate(),file_name=:fileName, dncId=:dncId,groupname=:groupname, DailingMode=:DailingMode,Queue=:Queue,dispositionID=:dispositionID,previewOption=:previewOption WHERE campaign_id = :campaignId";
